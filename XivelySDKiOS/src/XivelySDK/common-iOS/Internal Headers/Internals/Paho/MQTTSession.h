...
- (uint16_t)publishDataAtLeastOnce:(NSData*)theData onTopic:(NSString*)theTopic;
- (uint16_t)publishDataAtLeastOnce:(NSData*)theData onTopic:(NSString*)theTopic retain:(BOOL)retainFlag;
...
- (uint16_t)publishDataExactlyOnce:(NSData*)theData onTopic:(NSString*)theTopic;
- (uint16_t)publishDataExactlyOnce:(NSData*)theData onTopic:(NSString*)theTopic retain:(BOOL)retainFlag;
